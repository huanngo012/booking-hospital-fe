...
// import PopupDetailRecord from "../pages/user/PopupDetailRecord";
// import PopupCancelBooking from "../pages/user/PopupCancelBooking";
...
//         return (
//           <Typography variant="body2" className="truncate_2">
//             {text ? t("booking.paid") : t("booking.unpaid")}
//           </Typography>
//         );
//       },
//     },
...
//             actionList={
//               <>
//                 <PopupDetailRecord data={params.row} />
